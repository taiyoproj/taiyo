...
def test_solr_class_text_types():
...
def test_solr_class_boolean_types():
...
def test_solr_class_numeric_types():
...
def test_solr_class_date_currency_types():
...
def test_solr_class_spatial_types():
...
def test_solr_class_is_string_enum():
