...
def test_standard():
    ...
    with SolrClient(SOLR_URL) as client:
        ...
        fields = [
            SolrField(name="title", type="text_general", stored=True, indexed=True, multi_valued=False),
            SolrField(name="content", type="text_general", stored=True, indexed=True, multi_valued=False),
        ...
        # Test boolean query
        parser2 = StandardParser(query="category:technology AND content:neural", rows=10)
